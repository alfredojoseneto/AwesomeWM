...
local theme = "default" -- choosing a specific theme
local theme_path = string.format("~/.config/awesome/themes/%s/theme.lua", theme)
...
awful.rules.rules = {
	...
	--
	--
	{ rule = { class = "Terminator" }, properties = { screen = 1, tag = " 1 " } },
